...
const ClubMap = dynamic(() => import('../../components/HullMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'Hull City Official Supporters Club (HCOSC)',
        type: 'supporter_club',
        city: 'Hull',
        country: 'UK',
        website: 'https://www.hullcityosc.org',
        description: 'The only supporters club affiliated directly to Hull City FC. Bringing Tigers fans together for matchdays, events and community.',
      },
      {
        name: 'Tigers Trust',
        type: 'supporter_club',
        city: 'Hull',
        country: 'UK',
        website: 'https://www.tigerstrust.co.uk',
        description: 'Hull City\'s official charitable trust, making a difference to lives across Hull and East Yorkshire through sport.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Hull City Scandinavian Arctic Tigers',
        type: 'supporter_club',
        city: 'Oslo',
        country: 'Norway',
        website: 'https://www.wearehullcity.co.uk/fans/',
        description: 'Official Hull City supporters club in Scandinavia, founded in 2009. Part of the HCOSC branch network.',
      },
      {
        name: 'Hull City Netherlands Supporters',
        type: 'supporter_club',
        city: 'Amsterdam',
        country: 'Netherlands',
        website: 'https://www.wearehullcity.co.uk/fans/',
        description: 'Hull City supporters club in the Netherlands, founded by enthusiastic Tigers fans.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Hull City USA Supporters',
        type: 'supporter_club',
        city: 'Nationwide',
        country: 'USA',
        website: 'https://www.wearehullcity.co.uk/fans/',
        description: 'Hull City supporters across the USA. Find your nearest Tigers community.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Hull City Australia',
        type: 'supporter_club',
        city: 'Sydney',
        country: 'Australia',
        website: 'https://www.wearehullcity.co.uk/fans/',
        description: 'Hull City supporters in Australia, part of the global Tigers fan network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Hull City Ireland',
        type: 'supporter_club',
        city: 'Dublin',
        country: 'Ireland',
        website: 'https://www.wearehullcity.co.uk/fans/',
        description: 'Hull City supporters in Ireland, part of the global Tigers fan network.',
      },
    ],
  },
];
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Hull City</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Tigers · Est. 1904</div>
      </nav>

      {/* Hero */}
      <section style={{ padding: '60px 32px 48px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: `linear-gradient(180deg, rgba(245,161,46,0.06) 0%, transparent 100%)` }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(245,161,46,0.12)', border: '1px solid rgba(245,161,46,0.25)', borderRadius: '999px', padding: '5px 12px', marginBottom: '24px', fontSize: '11px', color: CLUB_COLOR, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
          ...
          <h1 style={{ fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.02em', marginBottom: '16px' }}>
            Tigers fans,<br /><span style={{ color: CLUB_COLOR }}>all over the world.</span>
          </h1>
      ...
      <section id="map" style={{ height: '480px', position: 'relative', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ position: 'absolute', top: '16px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '8px 16px', fontSize: '12px', color: 'rgba(255,255,255,0.6)', whiteSpace: 'nowrap', zIndex: 10 }}>
          Hull City fan groups worldwide
        </div>
      </section>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(245,161,46,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(245,161,46,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(245,161,46,0.05)'; }}
        ...
        <div style={{ marginTop: '48px', padding: '28px', borderRadius: '12px', border: '1px dashed rgba(255,255,255,0.12)', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginBottom: '16px' }}>We're building the most complete directory of Hull City fan groups worldwide.</p>
      ...
      <footer style={{ padding: '24px 32px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.15)' }}>Terrace. · Hull City · City Till We Die</span>
      </footer>
