...
const ClubMap = dynamic(() => import('../../components/NottinghamForestMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'Nottingham Forest Supporters Trust',
        type: 'supporter_club',
        city: 'Nottingham',
        country: 'UK',
        website: 'https://nffctrust.org',
        description: 'Independent, democratic, not-for-profit membership organisation run by fans for fans. Giving Forest supporters a voice at club and national level.',
      },
      {
        name: 'Nottingham Forest Supporters Club',
        type: 'supporter_club',
        city: 'Nottingham',
        country: 'UK',
        website: 'https://www.nottinghamforestsupportersclub.co.uk',
        description: 'The official supporters club with 50 branches worldwide. Helping Forest fans get to games and representing supporters to the club.',
      },
      {
        name: 'NFSC South West & South Wales Branch',
        type: 'supporter_club',
        city: 'Bristol',
        country: 'UK',
        website: 'https://www.nf-sc.org',
        description: 'Official branch of the Nottingham Forest Supporters Club serving fans across the West Country and South Wales.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Forest USA Supporters',
        type: 'supporter_club',
        city: 'Nationwide',
        country: 'USA',
        website: 'https://www.nottinghamforest.co.uk/your-club/matchday-supporter-guides/',
        description: 'Nottingham Forest supporters across the USA. Find your nearest Tricky Trees community.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Forest Australia',
        type: 'supporter_club',
        city: 'Sydney',
        country: 'Australia',
        website: 'https://www.nottinghamforest.co.uk/your-club/matchday-supporter-guides/',
        description: 'Nottingham Forest supporters in Australia, part of the global NFSC branch network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        country: 'Ireland',
        website: 'https://www.nottinghamforest.co.uk/your-club/matchday-supporter-guides/',
        description: 'Nottingham Forest supporters in Ireland, part of the global NFSC branch network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Forest Scandinavia',
        type: 'supporter_club',
        city: 'Oslo',
        country: 'Norway',
        website: 'https://www.nottinghamforest.co.uk/your-club/matchday-supporter-guides/',
        description: 'Nottingham Forest supporters in Scandinavia, part of the global NFSC branch network.',
      },
    ],
  },
];
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Nottingham Forest</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Tricky Trees · Est. 1865</div>
      </nav>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(221,0,0,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(221,0,0,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(221,0,0,0.05)'; }}
