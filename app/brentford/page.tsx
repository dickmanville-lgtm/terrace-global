...
const ClubMap = dynamic(() => import('../../components/BrentfordMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'BIAS — Brentford Independent Association of Supporters',
        type: 'supporter_club',
        city: 'London',
        country: 'UK',
        website: 'https://www.bias.org.uk',
        description: 'Established in 1997, BIAS is the official independent supporters group for Brentford fans. Nearly 4,000 members, FSA affiliated and officially recognised by the club.',
      },
      {
        name: 'Bees United',
        type: 'supporter_club',
        city: 'London',
        country: 'UK',
        website: 'https://www.beesunited.org.uk',
        description: 'The Brentford FC Supporters Trust — unique in the Premier League with a seat on the club board and a golden share to safeguard the club\'s future.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Brentford USA Supporters',
        type: 'supporter_club',
        city: 'Nationwide',
        country: 'USA',
        website: 'https://www.brentfordfc.com/en/brentford-fc-international-supporters-club-branch-map',
        description: 'Brentford supporters across the USA. Find your nearest Bees community via the official international supporters map.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Brentford FC Australia',
        type: 'supporter_club',
        city: 'Sydney',
        country: 'Australia',
        website: 'https://www.brentfordfc.com/en/brentford-fc-international-supporters-club-branch-map',
        description: 'Official Brentford FC supporters group in Australia, part of the international branch network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Brentford FC Canada',
        type: 'supporter_club',
        city: 'Toronto',
        country: 'Canada',
        website: 'https://www.brentfordfc.com/en/brentford-fc-international-supporters-club-branch-map',
        description: 'Official Brentford FC supporters group in Canada, part of the international branch network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Brentford FC Scandinavia',
        type: 'supporter_club',
        city: 'Oslo',
        country: 'Norway',
        website: 'https://www.brentfordfc.com/en/brentford-fc-international-supporters-club-branch-map',
        description: 'Official Brentford FC supporters group in Scandinavia, part of the international branch network.',
      },
    ],
  },
];
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Brentford FC</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Bees · Est. 1889</div>
      </nav>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(227,6,19,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(227,6,19,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(227,6,19,0.05)'; }}
