...
const ClubMap = dynamic(() => import('../../components/SunderlandMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'SAFC Branch Liaison Council',
        type: 'supporter_club',
        city: 'Sunderland',
        country: 'UK',
        website: 'https://safcblc.com',
        description: 'Represents over 70 official Sunderland AFC supporter branches. Works directly with the club on supporter issues at the Stadium of Light.',
      },
      {
        name: 'SAFC Heart of England Branch',
        type: 'supporter_club',
        city: 'Midlands',
        country: 'UK',
        website: 'http://www.safcsahoe.co.uk',
        description: 'Serving exiled Mackems and supporters living in the English Midlands.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'SAFC North America (NASA)',
        type: 'supporter_club',
        city: 'Nationwide',
        country: 'USA & Canada',
        website: 'https://www.safcnasa.com',
        description: 'Founded in 2013 to unite Sunderland supporters across North America. Officially recognised by Sunderland AFC.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        city: 'Sydney',
        country: 'Australia',
        website: 'https://www.safc.com/fans/supporters-branches',
        description: 'Official Sunderland AFC supporter branch in Australia, part of the global branch network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        country: 'Ireland',
        website: 'https://www.safc.com/fans/supporters-branches',
        description: 'Official Sunderland AFC supporter branch in Ireland, part of the global branch network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'SAFC Scandinavia',
        type: 'supporter_club',
        city: 'Oslo',
        country: 'Norway',
        website: 'https://www.safc.com/fans/supporters-branches',
        description: 'Official Sunderland AFC supporter branch in Scandinavia, part of the global branch network.',
      },
    ],
  },
];
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Sunderland AFC</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Black Cats · Est. 1879</div>
      </nav>

      {/* Hero */}
      <section style={{ padding: '60px 32px 48px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: `linear-gradient(180deg, rgba(235,23,43,0.06) 0%, transparent 100%)` }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(235,23,43,0.12)', border: '1px solid rgba(235,23,43,0.25)', borderRadius: '999px', padding: '5px 12px', marginBottom: '24px', fontSize: '11px', color: CLUB_COLOR, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
          ...
          <h1 style={{ fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.02em', marginBottom: '16px' }}>
            Mackem fans,<br /><span style={{ color: CLUB_COLOR }}>all over the world.</span>
          </h1>
          <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, maxWidth: '520px', marginBottom: '32px' }}>
            Find fellow Black Cats worldwide — 70+ official supporter branches across the globe. Ha'way the Lads.
          </p>
      ...
      <section id="map" style={{ height: '480px', position: 'relative', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ position: 'absolute', top: '16px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '8px 16px', fontSize: '12px', color: 'rgba(255,255,255,0.6)', whiteSpace: 'nowrap', zIndex: 10 }}>
          Sunderland AFC fan groups worldwide
        </div>
      </section>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        <p style={{ color: 'rgba(255,255,255,0.4)', fontSize: '14px', marginBottom: '48px' }}>
          Official supporter branches and fan communities worldwide. Click any group to visit their site.
        </p>
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(235,23,43,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(235,23,43,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(235,23,43,0.05)'; }}
        ...
        <div style={{ marginTop: '48px', padding: '28px', borderRadius: '12px', border: '1px dashed rgba(255,255,255,0.12)', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginBottom: '16px' }}>We're building the most complete directory of Sunderland AFC fan groups worldwide.</p>
      ...
      <footer style={{ padding: '24px 32px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.15)' }}>Terrace. · Sunderland AFC · Ha'way the Lads</span>
      </footer>
