...
const tools = [
  ...
  { href: '/admin/club-map', label: 'Browse & edit club content', desc: 'View, edit, and delete grounds; add or edit page content per club' },
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif", padding: '48px 32px' }}>
      <div style={{ maxWidth: '600px', margin: '0 auto' }}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '32px' }}>
          <h1 style={{ fontSize: '24px', fontWeight: 700 }}>yourpeople.football Admin</h1>
          <form action={logout}>
