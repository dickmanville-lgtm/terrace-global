...
export default async function RangersPage() {
  ...
  const CLUB_COLOR = club.color || '#0066CC';
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Nav */}
      <SiteNav active="supporter-groups" club={{ name: 'Rangers FC', color: CLUB_COLOR, tagline: 'The Gers · Est. 1872' }} />
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, maxWidth: '520px', marginBottom: '32px' }}>
            Find fellow Gers worldwide — 600+ official supporter clubs across the globe. No Surrender.
                ...
                <HeroActionButtons clubColor={CLUB_COLOR} clubId={club.id} clubSlug="rangers" clubName="Rangers" />
        </div>
      </section>
