...
const ClubMap = dynamic(() => import('../../components/BournemouthMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'AFC Bournemouth International Supporters',
        type: 'supporter_club',
        city: 'Bournemouth',
        country: 'UK',
        website: 'https://www.afcb.co.uk/for-fans/our-global-fanbase/supporter-groups',
        description: 'The official home for all AFC Bournemouth supporter groups worldwide. Find your nearest Cherries community.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'NACHOS — AFCB DC Supporters',
        type: 'supporter_club',
        city: 'Washington DC',
        country: 'USA',
        website: 'https://www.facebook.com/AFCBournemouthNACHOS/',
        description: 'Official AFC Bournemouth supporters club in Washington DC.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'AFCB Ireland Fans',
        type: 'supporter_club',
        city: 'Dublin',
        country: 'Ireland',
        website: 'https://www.facebook.com/AFCBournemouthIrishSupportersClub',
        description: 'Official AFC Bournemouth supporters club in Ireland.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'AFCB Central Coast Supporters',
        type: 'supporter_club',
        city: 'Central Coast, NSW',
        country: 'Australia',
        website: 'https://www.facebook.com/AFCBCentralCoast',
        description: 'Official AFC Bournemouth supporters club on the Central Coast of New South Wales.',
      },
      {
        name: 'AFCB Sydney Supporters',
        type: 'supporter_club',
        city: 'Sydney',
        country: 'Australia',
        website: 'https://www.facebook.com/afcb.sydney',
        description: 'Official AFC Bournemouth supporters club in Sydney, Australia.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'AFC Bournemouth France',
        type: 'supporter_club',
        city: 'France',
        country: 'France',
        website: 'https://www.facebook.com/AFCBour76521335',
        description: 'Official AFC Bournemouth supporters club in France.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'AFCB Ugandan Cherries',
        type: 'supporter_club',
        city: 'Kakira',
        country: 'Uganda',
        website: 'https://www.facebook.com/BournemouthKakiraFC',
        description: 'AFC Bournemouth supporters club in Uganda — flying the Cherries flag in East Africa.',
      },
    ],
  },
];
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>AFC Bournemouth</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Cherries · Est. 1899</div>
      </nav>
      ...
      <section style={{ padding: '60px 32px 48px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: `linear-gradient(180deg, rgba(218,41,28,0.06) 0%, transparent 100%)` }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <h1 style={{ fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.02em', marginBottom: '16px' }}>
            Cherries fans,<br /><span style={{ color: CLUB_COLOR }}>all over the world.</span>
          </h1>
          <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, maxWidth: '520px', marginBottom: '32px' }}>
            Find fellow Cherries worldwide — supporter communities from Bournemouth to beyond. Come On You Reds.
          </p>
      ...
      <section id="map" style={{ height: '480px', position: 'relative', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ position: 'absolute', top: '16px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '8px 16px', fontSize: '12px', color: 'rgba(255,255,255,0.6)', whiteSpace: 'nowrap', zIndex: 10 }}>
          AFC Bournemouth fan groups worldwide
        </div>
      </section>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        <div style={{ marginTop: '48px', padding: '28px', borderRadius: '12px', border: '1px dashed rgba(255,255,255,0.12)', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginBottom: '16px' }}>We're building the most complete directory of AFC Bournemouth fan groups worldwide.</p>
      ...
      <footer style={{ padding: '24px 32px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.15)' }}>Terrace. · AFC Bournemouth · Come On You Reds</span>
      </footer>
