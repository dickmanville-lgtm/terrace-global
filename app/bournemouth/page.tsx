...
export default async function BournemouthPage() {
  ...
  const CLUB_COLOR = club.color || '#DA291C';
  ...
  return (
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      {/* Nav */}
      <SiteNav active="supporter-groups" club={{ name: 'AFC Bournemouth', color: CLUB_COLOR, tagline: 'The Cherries · Est. 1899' }} />
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <p style={{ fontSize: '16px', color: 'rgba(255,255,255,0.5)', lineHeight: 1.7, maxWidth: '520px', marginBottom: '32px' }}>
            Find fellow Cherries worldwide — supporter communities from Bournemouth to beyond. Come On You Reds.
             ...
             <HeroActionButtons clubColor={CLUB_COLOR} clubId={club.id} clubSlug="bournemouth" clubName="AFC Bournemouth" />
        </div>
      </section>
