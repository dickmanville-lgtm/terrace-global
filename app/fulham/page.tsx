...
const ClubMap = dynamic(() => import('../../components/FulhamMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'Friends of Fulham',
        type: 'community',
        city: 'London',
        country: 'UK',
        website: 'https://friendsoffulham.com',
        description: 'Fan-created community for Fulham supporters since 2008. Forum, pub guide, club history and more — all by fans, for fans.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        city: 'Washington DC',
        country: 'USA',
        website: 'https://www.fulhamfc.com/fans/international-supporters-groups/fulham-dc/',
        description: 'Official Fulham FC supporters group in Washington DC, officially recognised by the club.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Australia & New Zealand Fulham Supporters',
        type: 'supporter_club',
        city: 'Sydney',
        country: 'Australia',
        website: 'https://www.fulhamfc.com/fans/international-supporters-groups/australian-and-new-zealand-fulham-fc-supporters-club/',
        description: 'Official Fulham FC supporters group for fans across Australia and New Zealand.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Fulham Supporters Club Norway',
        type: 'supporter_club',
        city: 'Oslo',
        country: 'Norway',
        website: 'https://www.fulhamfc.com/fans/international-supporters-groups/fulham-supporters-club-norway/',
        description: 'Official Fulham FC supporters club in Norway, officially recognised by the club.',
      },
      {
        name: 'Fulham FC Sweden',
        type: 'supporter_club',
        city: 'Stockholm',
        country: 'Sweden',
        website: 'https://www.fulhamfc.com/fans/international-supporters-groups/',
        description: 'Official Fulham FC supporters club in Sweden, part of the international supporters network.',
      },
      {
        name: 'Fulham FC Netherlands',
        type: 'supporter_club',
        city: 'Amsterdam',
        country: 'Netherlands',
        website: 'https://www.fulhamfc.com/fans/international-supporters-groups/',
        description: 'Official Fulham FC supporters club in the Netherlands, part of the international supporters network.',
      },
    ],
  },
];
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(204,0,0,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(204,0,0,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(204,0,0,0.05)'; }}
