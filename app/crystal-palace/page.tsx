...
const ClubMap = dynamic(() => import('../../components/CrystalPalaceMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'Crystal Palace Independent Supporters Association (CPISA)',
        type: 'supporter_club',
        city: 'London',
        country: 'UK',
        website: 'https://cpisa.co.uk',
        description: 'Independent, volunteer-led supporters association for Palace fans. Free membership, with representation on the Fan Advisory Board and regular meetings with the club.',
      },
      {
        name: 'The Holmesdale Online',
        type: 'community',
        city: 'London',
        country: 'UK',
        website: 'https://www.holmesdale.net',
        description: 'The longest-running Crystal Palace fan website, run by fans for fans since 1999. News, forums and Palace community.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        city: 'Nationwide',
        country: 'USA',
        website: 'https://www.cpfcusa.com',
        description: 'Directory of Crystal Palace supporters clubs and groups across the United States. Find your nearest Eagles community.',
      },
      {
        name: 'CPFC San Francisco',
        type: 'supporter_club',
        city: 'San Francisco',
        country: 'USA',
        website: 'https://www.cpfc.co.uk/supporters/international-supporters-clubs/',
        description: 'Official Crystal Palace supporters club in San Francisco, part of the international supporters network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        country: 'Australia',
        website: 'https://www.cpfc.co.uk/supporters/international-supporters-clubs/',
        description: 'Official Crystal Palace supporters club in Australia, part of the international supporters network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        country: 'Canada',
        website: 'https://www.cpfc.co.uk/supporters/international-supporters-clubs/',
        description: 'Official Crystal Palace supporters club in Canada, part of the international supporters network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        country: 'Ireland',
        website: 'https://www.cpfc.co.uk/supporters/international-supporters-clubs/',
        description: 'Official Crystal Palace supporters club in Ireland, part of the international supporters network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'CPFC Scandinavia',
        type: 'supporter_club',
        city: 'Oslo',
        country: 'Norway',
        website: 'https://www.cpfc.co.uk/supporters/international-supporters-clubs/',
        description: 'Official Crystal Palace supporters club in Scandinavia, part of the international supporters network.',
      },
    ],
  },
];
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Crystal Palace</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Eagles · Est. 1905</div>
      </nav>

      {/* Hero */}
      <section style={{ padding: '60px 32px 48px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: `linear-gradient(180deg, rgba(27,69,143,0.06) 0%, transparent 100%)` }}>
        <div style={{ maxWidth: '800px', margin: '0 auto' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', background: 'rgba(27,69,143,0.12)', border: '1px solid rgba(27,69,143,0.25)', borderRadius: '999px', padding: '5px 12px', marginBottom: '24px', fontSize: '11px', color: CLUB_COLOR, fontWeight: 600, letterSpacing: '0.08em', textTransform: 'uppercase' }}>
          ...
          <h1 style={{ fontSize: 'clamp(36px, 6vw, 64px)', fontWeight: 800, lineHeight: 1.05, letterSpacing: '-0.02em', marginBottom: '16px' }}>
            Eagles fans,<br /><span style={{ color: CLUB_COLOR }}>all over the world.</span>
          </h1>
      ...
      <section id="map" style={{ height: '480px', position: 'relative', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ position: 'absolute', top: '16px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '8px 16px', fontSize: '12px', color: 'rgba(255,255,255,0.6)', whiteSpace: 'nowrap', zIndex: 10 }}>
          Crystal Palace fan groups worldwide
        </div>
      </section>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(27,69,143,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(27,69,143,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(27,69,143,0.05)'; }}
        ...
        <div style={{ marginTop: '48px', padding: '28px', borderRadius: '12px', border: '1px dashed rgba(255,255,255,0.12)', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginBottom: '16px' }}>We're building the most complete directory of Crystal Palace fan groups worldwide.</p>
      ...
      <footer style={{ padding: '24px 32px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.15)' }}>Terrace. · Crystal Palace · Glad All Over</span>
      </footer>
