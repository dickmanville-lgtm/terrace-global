...
const ClubMap = dynamic(() => import('../../components/BrightonMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'Brighton & Hove Albion Supporters Club',
        type: 'supporter_club',
        city: 'Brighton',
        country: 'UK',
        website: 'https://bhasc.com/wp/',
        description: 'Founded in 1912, the oldest Brighton supporters club. Independent and democratic, helping fans support the Albion for over a century.',
      },
      {
        name: 'Seagulls Over London',
        type: 'supporter_club',
        city: 'London',
        country: 'UK',
        website: 'http://www.seagullsoverlondon.com',
        description: 'Official supporters club for Brighton fans in London. Regular Q&A meetings with club officials in the capital.',
      },
      {
        name: 'Proud Seagulls',
        type: 'community',
        city: 'Brighton',
        country: 'UK',
        website: 'https://proudseagulls.com',
        description: 'The official LGBTQ+ and Allies fan group for Brighton & Hove Albion. Founded in 2017, officially recognised by the club since 2022.',
      },
      {
        name: 'BHAlba Scottish Seagulls',
        type: 'supporter_club',
        city: 'Scotland',
        country: 'UK',
        website: 'https://www.brightonandhovealbion.com/supporters-club-map',
        description: 'Official Brighton & Hove Albion supporters club in Scotland.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Houston Seagulls',
        type: 'supporter_club',
        city: 'Houston',
        country: 'USA',
        website: 'https://houstonseagulls.com',
        description: 'Official Brighton & Hove Albion supporters club in Houston. Watch parties at the Velvet Oak Tavern.',
      },
      {
        name: 'Stateside Seagulls',
        type: 'supporter_club',
        city: 'Nationwide',
        country: 'USA',
        website: 'https://www.brightonandhovealbion.com/supporters-club-map',
        description: 'Official Brighton & Hove Albion supporters club network across the USA.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Hong Kong Seagulls',
        type: 'supporter_club',
        city: 'Hong Kong',
        country: 'China',
        website: 'https://www.brightonandhovealbion.com/supporters-club-map',
        description: 'Official Brighton & Hove Albion supporters club in Hong Kong.',
      },
      {
        name: 'Singapore Seagulls',
        type: 'supporter_club',
        city: 'Singapore',
        country: 'Singapore',
        website: 'https://www.brightonandhovealbion.com/supporters-club-map',
        description: 'Official Brighton & Hove Albion supporters club in Singapore.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Hellas Seagulls',
        type: 'supporter_club',
        city: 'Athens',
        country: 'Greece',
        website: 'https://www.brightonandhovealbion.com/supporters-club-map',
        description: 'Official Brighton & Hove Albion supporters club in Greece.',
      },
      {
        name: 'Seagulls Over Spain',
        type: 'supporter_club',
        city: 'Spain',
        country: 'Spain',
        website: 'https://www.brightonandhovealbion.com/supporters-club-map',
        description: 'Official Brighton & Hove Albion supporters club in Spain.',
      },
    ],
  },
];
    ...
    <main style={{ minHeight: '100vh', background: '#0a0a0a', color: '#fff', fontFamily: "'Inter', sans-serif" }}>
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Brighton & Hove Albion</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Seagulls · Est. 1901</div>
      </nav>

      {/* Hero */}
      <section style={{ padding: '60px 32px 48px', borderBottom: '1px solid rgba(255,255,255,0.06)', background: `linear-gradient(180deg, rgba(0,87,184,0.06) 0%, transparent 100%)` }}>
      ...
      <section id="map" style={{ height: '480px', position: 'relative', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <div style={{ position: 'absolute', top: '16px', left: '50%', transform: 'translateX(-50%)', background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(8px)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: '8px', padding: '8px 16px', fontSize: '12px', color: 'rgba(255,255,255,0.6)', whiteSpace: 'nowrap', zIndex: 10 }}>
          Brighton & Hove Albion fan groups worldwide
        </div>
      </section>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(0,87,184,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(0,87,184,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(0,87,184,0.05)'; }}
        ...
        <div style={{ marginTop: '48px', padding: '28px', borderRadius: '12px', border: '1px dashed rgba(255,255,255,0.12)', textAlign: 'center' }}>
          ...
          <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginBottom: '16px' }}>We're building the most complete directory of Brighton & Hove Albion fan groups worldwide.</p>
      ...
      <footer style={{ padding: '24px 32px', borderTop: '1px solid rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.15)' }}>Terrace. · Brighton & Hove Albion · Come On You Seagulls</span>
      </footer>
