...
const ClubMap = dynamic(() => import('../../components/EvertonMap'), {
  ssr: false,
  loading: () => (
    <div style={{
...
const SUPPORTER_CLUBS = [
  {
    ...
    groups: [
      {
        name: 'Everton FC Official Supporters Clubs',
        type: 'supporter_club',
        city: 'Liverpool',
        country: 'UK',
        website: 'https://www.evertonfc.com/fans/supporters-clubs/directory',
        description: 'The official directory of Everton FC supporters clubs worldwide. Find your nearest branch across the UK and beyond.',
      },
      {
        name: 'Everton Supporters Club East Midlands (ESCEM)',
        type: 'supporter_club',
        city: 'East Midlands',
        country: 'UK',
        website: 'https://www.escem.co.uk',
        description: 'Official affiliate supporters club for Evertonians across the East Midlands. Coach trips to every home game at the Hill Dickinson Stadium.',
      },
      {
        name: 'ToffeeWeb',
        type: 'community',
        city: 'Liverpool',
        country: 'UK',
        website: 'https://www.toffeeweb.com',
        description: 'The leading independent Everton fan website. News, debate, overseas supporters club directory and Evertonian community since 1995.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Everton USA Supporters',
        type: 'supporter_club',
        city: 'Nationwide',
        country: 'USA',
        website: 'https://www.evertonfc.com/fans/supporters-clubs/directory',
        description: 'Find Everton supporters clubs across the USA via the official Everton FC directory.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Everton Australia',
        type: 'supporter_club',
        city: 'Sydney',
        country: 'Australia',
        website: 'https://www.evertonfc.com/fans/supporters-clubs/directory',
        description: 'Official Everton FC supporters club in Australia, part of the worldwide supporters network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Everton Ireland',
        type: 'supporter_club',
        city: 'Dublin',
        country: 'Ireland',
        website: 'https://www.evertonfc.com/fans/supporters-clubs/directory',
        description: 'Official Everton FC supporters club in Ireland, part of the worldwide supporters network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        name: 'Everton Scandinavia',
        type: 'supporter_club',
        city: 'Oslo',
        country: 'Norway',
        website: 'https://www.evertonfc.com/fans/supporters-clubs/directory',
        description: 'Official Everton FC supporters club in Scandinavia, part of the worldwide supporters network.',
      },
    ],
  },
  {
    ...
    groups: [
      {
        ...
        country: 'Singapore',
        website: 'https://www.evertonfc.com/fans/supporters-clubs/directory',
        description: 'Official Everton FC supporters club in Asia, part of the worldwide supporters network.',
      },
    ],
  },
];
      ...
      <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 32px', borderBottom: '1px solid rgba(255,255,255,0.08)', position: 'sticky', top: 0, background: 'rgba(10,10,10,0.95)', backdropFilter: 'blur(12px)', zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontSize: '14px', fontWeight: 700, letterSpacing: '0.08em', textTransform: 'uppercase' }}>Everton FC</span>
          </div>
        </div>
        <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.3)', fontStyle: 'italic' }}>The Toffees · Est. 1878</div>
      </nav>
      ...
      <section id="directory" style={{ padding: '64px 32px', maxWidth: '960px', margin: '0 auto' }}>
        ...
        {SUPPORTER_CLUBS.map(region => (
          <div key={region.region} style={{ marginBottom: '48px' }}>
            <h3 style={{ fontSize: '13px', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: CLUB_COLOR, marginBottom: '16px', paddingBottom: '8px', borderBottom: `1px solid rgba(0,51,153,0.2)` }}>
              {region.region}
            </h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {region.groups.map(group => (
                <a key={group.name} href={group.website} target="_blank" rel="noopener noreferrer"
                  ...
                  onMouseEnter={e => { (e.currentTarget as HTMLElement).style.borderColor = 'rgba(0,51,153,0.3)'; (e.currentTarget as HTMLElement).style.background = 'rgba(0,51,153,0.05)'; }}
