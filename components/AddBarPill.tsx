...
import PublicSubmitSportsBarForm from './PublicSubmitSportsBarForm'

export default function AddBarPill({
  accentColor = '#F97316',
  label = 'Add your bar',
        ...
        >
          ...
          >
            ...
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.4)', marginBottom: '20px' }}>
              We&apos;ll check it and add it to the map.
            </p>
            <PublicSubmitSportsBarForm accentColor={accentColor} />
          </div>
        </div>
      )}
    </>
